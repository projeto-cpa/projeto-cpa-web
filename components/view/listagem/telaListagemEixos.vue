                    ...
                    <div class="card-body">
                        <div class="row m-0">
                            ...
                            <div class="col m-auto">
                                <div class="item header text-center"><b>Nome do eixo</b></div>
                            </div>
                            <div class="col m-auto">
                                <div class="item header text-center"><b>Descrição do eixo</b></div>
                            </div>
                ...
                <template v-else>
                    ...
                    <div class="card-list">
                        <div v-for="(item, index) in resultados" :key="index" :class="classeItem(item, index)"
                            class="card card-item mb-4 mb-lg-2" aria-hidden="true" data-item="eixo">
                            <div class="card-body">
                                <div class="row m-0">
                                    <div
                                            class="col-xl-auto col-12 mb-xl-auto col-md-6 id my-xl-auto mb-2 mb-xl-0 mt-0 mt-xl-auto">
