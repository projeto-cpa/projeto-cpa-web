        ...
        <section>
            <article>
                <template>
                    <div class="mb-3">
                        ...
                        <input class="form-control" style="width: 50%" type="text"
                            value="matheus.schuch@alunos.bpkedu.com.br" aria-label="Disabled input example" disabled />
                    </div>
                </template>
                ...
                <template>
                    ...
                    <div class="input-group mb-3" style="width: 50%">
                        ...
                        <button class="btn btn-outline-secondary" type="button" id="show-modal" data-bs-toggle="modal"
                            data-bs-target="#user" data-id="1">
                            Editar
                        </button>
                    </div>

                    <div id="user" class="modal" style="z-index: ;1051">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div container-fluid class="row g-3 align-items-center">
                                            <div class="col-auto">
                ...
                <template>
                    ...
                    <div class="input-group mb-3" style="width: 50%">
                        <input type="text" class="form-control" value="(XX) X  XXXX-XXXX" aria-label="Recipient's username"
                            aria-describedby="button-addon2" disabled />
                        <button class="btn btn-outline-secondary" type="button" id="show-modal" data-bs-toggle="modal"
                            data-bs-target="#fone" data-id="1">
                            Editar
                        </button>
                    </div>
                    <div id="fone" class="modal" style="z-index:1051">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Alterar Numero</h5>
                                    <button id="meu-modal" type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form>
                                        <div container-fluid class="row g-3 align-items-center">
                                            <div class="col-auto">
                                                <label for="InputName" class="col-form-label">Numero</label>
                                            </div>
                                            <div class="col-auto">
