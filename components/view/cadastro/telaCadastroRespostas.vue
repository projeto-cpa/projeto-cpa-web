...
export default {
    ...
    methods: {
        ...
        pegaTipo: function (valor) {
            console.log("vou pegar", typeof valor);
            this.tipoPergunta = valor;
        },
                                ...
                                <div class="form-floating">
                                                                        ...
                                                                        <template v-else-if="campo.tipo === 'select'">
                                                                            <select :placeholder="campo.etiqueta" :name="campo.nome" v-model="campo.valor"
                                                                                class="form-control" :id="campo.id"
                                                                                @change="campo.validar(); pegaTipo(campo.valor);"
                                                                ...
                                                                <template v-else-if="tipoPergunta === 2">
