...
import alteracaoCurso from '../../../api/alteracao/alteracaoCurso.js';
...
export default {
    ...
    methods: {
        ...
        enviarFormulario: async function () {
            ...
            var resposta = await alteracaoCurso(data);
            ...
            if (resposta.sucesso) {
                ...
                this.fecharCanvas();
                emmiter.emit('aoAlterarCurso', atualizado);
    ...
    mounted: function () {
        emmiter.on('abrirEdicaoCurso', this.abrirCanvas)
...
<template>
    <div class="offcanvas offcanvas-alterar offcanvas-end" ref="offcanvas" data-bs-backdrop="false" data-bs-scroll="true">
        <div class="offcanvas-header bg-primary text-white">
            <h5 class="offcanvas-title">Alteração do curso: #{{ identificacao }}</h5>
        ...
        <div class="offcanvas-body">
            ...
            <form class="row mx-0 mb-3" ref="formularioCadastro">
                ...
                <input type="hidden" name="idCurso" v-model="identificacao" class="d-none"/>
            </form>
